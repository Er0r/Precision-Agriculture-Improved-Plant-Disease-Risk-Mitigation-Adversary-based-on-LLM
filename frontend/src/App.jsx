...
import IndividualDiseaseComparison from './components/results/IndividualDiseaseComparison'
        ...
        <Routes>
          ...
          <Route path="/sentiment-analytics" element={
            <div>
              <div className="text-center mb-8">
                <h2 className="text-3xl font-bold text-gray-900 mb-4">
                  Our Approach vs Anchor Paper Approach
                </h2>
                <p className="text-xl text-gray-600 mb-2">
                  Comparative sentiment analysis: Solution-focused vs Problem-focused
                </p>
                <p className="text-gray-500">
                  Individual disease analysis showing how our positive treatment recommendations compare with negative problem descriptions from anchor paper literature
                </p>
              </div>
              <IndividualDiseaseComparison />
            </div>
          } />
        </Routes>
      </main>
