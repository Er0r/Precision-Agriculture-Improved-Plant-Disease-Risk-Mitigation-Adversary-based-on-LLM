"""
Test script to verify the rice disease detection setup
"""
...
def test_detector_creation():
    ...
    try:
        from rice_disease_detector import RiceDiseaseDetector, create_detector
...
def main():
    """Run all tests"""
    print("=== Rice Disease Detection Setup Test ===\n")
    ...
    print("\nYou can now:")
    print("1. Run the Jupyter notebook: rice_disease_analysis.ipynb")
