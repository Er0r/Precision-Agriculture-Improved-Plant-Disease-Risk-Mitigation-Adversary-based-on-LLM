"""
Jute Disease Detection Training Script
...
from jute_disease_detector import JuteDiseaseDetector

import argparse

def main():
    parser = argparse.ArgumentParser(description='Train Jute Disease Detection Model')
    ...
    parser.add_argument('--model-name', '-n', default='jute_disease_model', help='Model name for saving')
    
    args = parser.parse_args()
    
    print("=== Jute Disease Detection Training ===")
    ...
    if args.dataset_path:
        detector = JuteDiseaseDetector(dataset_path=args.dataset_path)
    else:
        detector = JuteDiseaseDetector()
    ...
    try:
        ...
        if args.model_name != 'jute_disease_model':
